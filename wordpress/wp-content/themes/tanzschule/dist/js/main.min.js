...
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t(require("jquery"),require("./util.js")):"function"==typeof define&&define.amd?define(["jquery","./util.js"],t):(e=e||self).Alert=t(e.jQuery,e.Util)}(this,function(i,u){"use strict";function s(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}i=i&&i.hasOwnProperty("default")?i.default:i,u=u&&u.hasOwnProperty("default")?u.default:u;var e="alert",l="bs.alert",t="."+l,n=i.fn[e],a={CLOSE:"close"+t,CLOSED:"closed"+t,CLICK_DATA_API:"click"+t+".data-api"},f="alert",c="fade",d="show",r=function(){function r(e){this._element=e}var e,t,n,o=r.prototype;return o.close=function(e){var t=this._element;e&&(t=this._getRootElement(e)),this._triggerCloseEvent(t).isDefaultPrevented()||this._removeElement(t)},o.dispose=function(){i.removeData(this._element,l),this._element=null},o._getRootElement=function(e){var t=u.getSelectorFromElement(e),n=!1;return t&&(n=document.querySelector(t)),n||(n=i(e).closest("."+f)[0]),n},o._triggerCloseEvent=function(e){var t=i.Event(a.CLOSE);return i(e).trigger(t),t},o._removeElement=function(t){var n=this;if(i(t).removeClass(d),i(t).hasClass(c)){var e=u.getTransitionDurationFromElement(t);i(t).one(u.TRANSITION_END,function(e){return n._destroyElement(t,e)}).emulateTransitionEnd(e)}else this._destroyElement(t)},o._destroyElement=function(e){i(e).detach().trigger(a.CLOSED).remove()},r._jQueryInterface=function(n){return this.each(function(){var e=i(this),t=e.data(l);t||(t=new r(this),e.data(l,t)),"close"===n&&t[n](this)})},r._handleDismiss=function(t){return function(e){e&&e.preventDefault(),t.close(this)}},e=r,n=[{key:"VERSION",get:function(){return"4.3.1"}}],(t=null)&&s(e.prototype,t),n&&s(e,n),r}();return i(document).on(a.CLICK_DATA_API,'[data-dismiss="alert"]',r._handleDismiss(new r)),i.fn[e]=r._jQueryInterface,i.fn[e].Constructor=r,i.fn[e].noConflict=function(){return i.fn[e]=n,r._jQueryInterface},r});
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):(e=e||self).Button=t(e.jQuery)}(this,function(r){"use strict";function a(e,t){for(var n=0;n<t.length;n++){var s=t[n];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}r=r&&r.hasOwnProperty("default")?r.default:r;var e="button",o="bs.button",t="."+o,n=".data-api",s=r.fn[e],u="active",i="btn",l="focus",c='[data-toggle^="button"]',f='[data-toggle="buttons"]',d='input:not([type="hidden"])',h=".active",_=".btn",g={CLICK_DATA_API:"click"+t+n,FOCUS_BLUR_DATA_API:"focus"+t+n+" blur"+t+n},b=function(){function n(e){this._element=e}var e,t,s,i=n.prototype;return i.toggle=function(){var e=!0,t=!0,n=r(this._element).closest(f)[0];if(n){var s=this._element.querySelector(d);if(s){if("radio"===s.type)if(s.checked&&this._element.classList.contains(u))e=!1;else{var i=n.querySelector(h);i&&r(i).removeClass(u)}if(e){if(s.hasAttribute("disabled")||n.hasAttribute("disabled")||s.classList.contains("disabled")||n.classList.contains("disabled"))return;s.checked=!this._element.classList.contains(u),r(s).trigger("change")}s.focus(),t=!1}}t&&this._element.setAttribute("aria-pressed",!this._element.classList.contains(u)),e&&r(this._element).toggleClass(u)},i.dispose=function(){r.removeData(this._element,o),this._element=null},n._jQueryInterface=function(t){return this.each(function(){var e=r(this).data(o);e||(e=new n(this),r(this).data(o,e)),"toggle"===t&&e[t]()})},e=n,s=[{key:"VERSION",get:function(){return"4.3.1"}}],(t=null)&&a(e.prototype,t),s&&a(e,s),n}();return r(document).on(g.CLICK_DATA_API,c,function(e){e.preventDefault();var t=e.target;r(t).hasClass(i)||(t=r(t).closest(_)),b._jQueryInterface.call(r(t),"toggle")}).on(g.FOCUS_BLUR_DATA_API,c,function(e){var t=r(e.target).closest(_)[0];r(t).toggleClass(l,/^focus(in)?$/.test(e.type))}),r.fn[e]=b._jQueryInterface,r.fn[e].Constructor=b,r.fn[e].noConflict=function(){return r.fn[e]=s,b._jQueryInterface},b});
...
!function(){if(window&&window.addEventListener){var t,n,c=Object.create(null),w=function(){clearTimeout(n),n=setTimeout(t,100)},v=function(){},m=function(e){function t(e){var t;return void 0!==e.protocol?t=e:(t=document.createElement("a")).href=e,t.protocol.replace(/:/g,"")+t.host}var n,o;return window.XMLHttpRequest&&(n=new XMLHttpRequest,o=t(location),e=t(e),n=void 0===n.withCredentials&&""!==e&&e!==o?XDomainRequest||void 0:XMLHttpRequest),n};t=function(){function o(){var e;0===--l&&(v(),window.addEventListener("resize",w,!1),window.addEventListener("orientationchange",w,!1),window.MutationObserver?((e=new MutationObserver(w)).observe(document.documentElement,{childList:!0,subtree:!0,attributes:!0}),v=function(){try{e.disconnect(),window.removeEventListener("resize",w,!1),window.removeEventListener("orientationchange",w,!1)}catch(e){}}):(document.documentElement.addEventListener("DOMSubtreeModified",w,!1),v=function(){document.documentElement.removeEventListener("DOMSubtreeModified",w,!1),window.removeEventListener("resize",w,!1),window.removeEventListener("orientationchange",w,!1)}))}function e(e){return function(){!0!==c[e.base]&&e.useEl.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href","#"+e.hash)}}function t(n){return function(){var e=document.body,t=document.createElement("x");n.onload=null,t.innerHTML=n.responseText,(t=t.getElementsByTagName("svg")[0])&&(t.setAttribute("aria-hidden","true"),t.style.position="absolute",t.style.width=0,t.style.height=0,t.style.overflow="hidden",e.insertBefore(t,e.firstChild)),o()}}function n(e){return function(){e.onerror=null,e.ontimeout=null,o()}}var i,r,d,u,s,a,l=0;for(v(),a=document.getElementsByTagName("use"),u=0;u<a.length;u+=1){try{r=a[u].getBoundingClientRect()}catch(e){r=!1}i=(d=(i=a[u].getAttributeNS("http://www.w3.org/1999/xlink","href"))&&i.split?i.split("#"):["",""])[0],d=d[1],s=r&&0===r.left&&0===r.right&&0===r.top&&0===r.bottom,r&&0===r.width&&0===r.height&&!s?i.length&&(!0!==(s=c[i])&&setTimeout(e({useEl:a[u],base:i,hash:d}),0),void 0===s&&(void 0!==(d=m(i))&&(s=new d,(c[i]=s).onload=t(s),s.onerror=n(s),s.ontimeout=n(s),s.open("GET",i),s.send(),l+=1))):s?i.length&&c[i]&&e({useEl:a[u],base:i,hash:d})():void 0===c[i]?c[i]=!0:c[i].onload&&(c[i].abort(),delete c[i].onload,c[i]=!0)}a="",l+=1,o()},window.addEventListener("load",function e(){window.removeEventListener("load",e,!1),n=setTimeout(t,0)},!1)}}();
...
!function(r){"use strict";jQuery(document).ready(function(){var e=r(".grid").isotope({itemSelector:".element-item",layoutMode:"fitRows",getSortData:{name:".name",symbol:".symbol",number:".number parseInt",category:"[data-category]",weight:function(t){var e=r(t).find(".weight").text();return parseFloat(e.replace(/[\(\)]/g,""))}}}),n={numberGreaterThan50:function(){var t=r(this).find(".number").text();return 50<parseInt(t,10)},ium:function(){return r(this).find(".name").text().match(/ium$/)}};r("#filters").on("click","button",function(){var t=r(this).attr("data-filter");t=n[t]||t,e.isotope({filter:t})}),r("#sorts").on("click","button",function(){var t=r(this).attr("data-sort-by");e.isotope({sortBy:t})}),r(".button-group").each(function(t,e){var n=r(e);n.on("click","button",function(){n.find(".is-checked").removeClass("is-checked"),r(this).addClass("is-checked")})})})}(jQuery);